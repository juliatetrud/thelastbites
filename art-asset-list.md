...
| ~~`room-ch01-radio-room.png`~~ | ~~Room background~~ | **RETIRED Sprint 19.** The radio in Chapter 1 lives in the grandparents' cabin (Dziadek's domestic radio, world-x ~200, windowsill) and as the ship's intercom (Beat 8). There is no separate radio-operator room. See `04-chapter-01-cabin-646.md` Beat 7. | — |
