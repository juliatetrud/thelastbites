...
> **Gallery-canonical (R03–R04, 2026-07-10).** Every Ch2–Ch8 chef, NPC, monster, and
> echo-creature below now has an approved draw function in `character-gallery.html` (the
> Ch2–Ch4 cast in Sprint R03 / #114; the Ch5–Ch8 cast in Sprint R04 / #115). Per the
...
> Ch8 Babcia/Dziadek use the namespaced `drawBabciaStanding`/`drawDziadekStanding` standing
> variants. Pip-shadow is the game's final threat register — treat with care.)
